sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("edu/jh/mh/stoRtns/StoRtns/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#STOReturns-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#STOReturns-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("edu.jh.mh.stoRtns.StoRtns.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["edu/jh/mh/stoRtns/StoRtns/localService/mockserver"], function (mockserver) {
