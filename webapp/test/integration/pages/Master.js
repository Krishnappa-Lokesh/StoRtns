		...
		onTheMasterPage: {
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function () {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "stortnhdrSet (0)"
						}),
						success: function () {
							Opa5.assert.ok(true, "The list header displays 'stortnhdrSet (0)'");
						},
				...
				theListShouldHaveAllEntries: function () {
					...
					// retrieve all stortnhdrSet to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function (oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "stortnhdrSet (" + iExpectedLength + ")"
								}),
								success: function () {
